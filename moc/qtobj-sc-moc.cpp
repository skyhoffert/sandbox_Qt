/****************************************************************************
** Meta object code from reading C++ file 'qtobj-sc.h'
**
...
#error "The header file 'qtobj-sc.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 16, 6) // "MySlot"

    },
    "MyObj\0MySignal\0\0MySlot"
};
...
void MyObj::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyObj::MySignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyObj::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyObj.data,
      qt_meta_data_MyObj,  qt_static_metacall, nullptr, nullptr}
};
